  ...
  const emailHtml = `
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 560px; margin: 0 auto; padding: 20px;">
      ...
      <p style="color: #333; font-size: 15px; line-height: 1.6;">
        We've received your interest in joining SocieteeGolf. A member of our committee will be in touch shortly to arrange your first round with us.
      </p>
      ...
      <div style="text-align: center; margin: 24px 0;">
        <a href="https://societeegolf.app" style="display: inline-block; background: #C9A84C; color: #152847; text-decoration: none; padding: 12px 28px; border-radius: 8px; font-weight: 600; font-size: 14px;">Visit Our Website</a>
      </div>
  ...
  try {
    const response = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        ...
        to: [email],
        subject: `Welcome to SocieteeGolf, ${name}!`,
        html: emailHtml
      })
    });
